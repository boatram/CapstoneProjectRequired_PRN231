            ...
            if (token != null && refreshToken != null && role != null)
            {
                ...
                if (role.Equals("Admin"))
                {
                    ...
                    if (!string.IsNullOrEmpty(searchString) && !string.IsNullOrEmpty(SearchBy))
                    {
                        ...
                        {
                            var rs = SendDataHelper<AccountResponse>.GetListData($"https://localhost:7298/odata/Accounts/?$expand=Specialization&$filter=RoleId eq 1 and contains(Name,\'{searchString}\')", token).Result;
                            if (rs != null)
                                list = rs.ToList();
                            else list = null;
                        }
                        ...
                        {
                            var rs = SendDataHelper<AccountResponse>.GetListData($"https://localhost:7298/odata/Accounts/?$expand=Specialization&$filter=RoleId eq 1 and contains(Code,\'{searchString}\')", token).Result;
                            if (rs != null)
                                list = rs.ToList();
                            else list = null;
                        }
                        ...
                        {
                            var rs = SendDataHelper<AccountResponse>.GetListData($"https://localhost:7298/odata/Accounts/?$expand=Specialization&$filter=RoleId eq 1 and contains(Email,\'{searchString}\')", token).Result;
                            if (rs != null)
                                list = rs.ToList();
                            else list = null;
                        }
                    ...
                    {
                        var rs = SendDataHelper<AccountResponse>.GetListData($"https://localhost:7298/odata/Accounts/?$expand=Specialization&$filter=RoleId eq 1", token).Result;
                        if (rs != null)
                            list = rs.ToList();
                        else list = null;
                    }
                    ...
                    if (list == null)
                    {
                        ...
                        if (customer != null)
                        {
                            ...
                            var rs = SendDataHelper<AccountResponse>.GetListData($"https://localhost:7298/odata/Accounts/?$expand=Specialization&$filter=RoleId eq 1", customer.Token).Result;
                            if (rs != null)
